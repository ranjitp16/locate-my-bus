...
const { handleWriteFromAgency, handleWriteFromRoutes, handleWriteFromShapes, handleWriteFromTrip, handleWriteFromStops, handleWriteFromStopTimes, handleWriteFromCalendar } = require('../repository/addAgency.js');
...
const onBoardAgency = async (rt_feed_url, static_feed_url, api_key) => {
    ...
    try {
        ...
        await handleWriteFromCalendar(client, 'calendar.txt', 'calendar', decompressed, listOfGuid, static_feed_url);
        await handleWriteFromCalendar(client, 'calendar_dates.txt', 'calendar_date', decompressed, listOfGuid, static_feed_url);
